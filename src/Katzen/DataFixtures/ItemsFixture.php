...
class ItemsFixture extends Fixture implements DependentFixtureInterface
{
    private const ITEMS = [
        ...
        ['name' => 'Cocoa Powder', 'category' => 'ingredient', 'subcategory' => 'dry goods'],
        ['name' => 'Cinnamon', 'category' => 'ingredient', 'subcategory' => 'dry goods'],        
        ...
        ['name' => 'Whole Milk', 'category' => 'ingredient', 'subcategory' => 'dairy'],
        ['name' => 'Oat Milk', 'category' => 'ingredient', 'subcategory' => 'dairy'],
        ['name' => 'Heavy Cream', 'category' => 'ingredient', 'subcategory' => 'dairy'],                
        ['name' => 'Chocolate', 'category' => 'ingredient', 'subcategory' => 'dry goods'],
        ['name' => 'Salt', 'category' => 'ingredient', 'subcategory' => 'dry goods'],
        ['name' => 'Espresso Beans', 'category' => 'ingredient', 'subcategory' => 'coffee'],
        ['name' => 'Drip Coffee Beans', 'category' => 'ingredient', 'subcategory' => 'coffee'],
        ['name' => 'Vanilla Syrup', 'category' => 'ingredient', 'subcategory' => 'syrup'],
        ['name' => 'Caramel Syrup', 'category' => 'ingredient', 'subcategory' => 'syrup'],
        ['name' => 'Ice', 'category' => 'ingredient', 'subcategory' => 'frozen'],
        
        // Packaging
        ['name' => '8oz Paper Cup', 'category' => 'packaging', 'subcategory' => 'container'],
        ['name' => '12oz Paper Cup', 'category' => 'packaging', 'subcategory' => 'container'],
        ['name' => '16oz Paper Cup', 'category' => 'packaging', 'subcategory' => 'container'],
        ['name' => 'Cup Sleeve', 'category' => 'packaging', 'subcategory' => 'container'],
        ['name' => 'Hot Drink Lid', 'category' => 'packaging', 'subcategory' => 'container'],        
        ['name' => '12oz Clear Cup', 'category' => 'packaging', 'subcategory' => 'container'],
        ['name' => '16oz Clear Cup', 'category' => 'packaging', 'subcategory' => 'container'],        
