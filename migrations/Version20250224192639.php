 ...
 */
final class Version20250224192639 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE recipe_instruction (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, instruction_id INT NOT NULL, recipe_id_id INT NOT NULL, PRIMARY KEY(id))');
