...
final class Version20260126023543 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE mapping_learning (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, column_name VARCHAR(255) NOT NULL, target_field VARCHAR(100) NOT NULL, entity_type VARCHAR(100) NOT NULL, header_fingerprint VARCHAR(64) DEFAULT NULL, success_count INT NOT NULL, failed_suggestions JSON DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX idx_mapping_learning_entity_type ON mapping_learning (entity_type)');
        $this->addSql('CREATE INDEX idx_mapping_learning_fingerprint ON mapping_learning (header_fingerprint)');
        $this->addSql('CREATE UNIQUE INDEX unique_column_field_entity ON mapping_learning (column_name, target_field, entity_type)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE mapping_learning');
    }
}
